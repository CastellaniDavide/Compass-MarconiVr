...
![Version](https://img.shields.io/badge/version-v03.01-blue?style=flat)
...
- [x] v2: Transform the app by webapp to native
- [x] v3: Multi-language option 
- [ ] v4: Add the possibility to have more than one school/ firm in app, w/ associated website and/ or app for the manager
- [ ] v5: Add upgrade option, with notification
...
#### Changed
- Nowe disponible in English & in Italian 
